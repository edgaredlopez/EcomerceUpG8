    ...
    ?>
  	<div class="register-box-body">
    	...
    	<form action="register.php" method="POST">
          ...
          <div class="form-group has-feedback">
            <input type="text" class="form-control" name="nit" placeholder="NIT" value="<?php echo (isset($_SESSION['nit'])) ? $_SESSION['nit'] : '' ?>"  required>
            <span class="glyphicon glyphicon-user form-control-feedback"></span>
          </div>
          <div class="form-group has-feedback">
            <input type="text" class="form-control" name="nit" placeholder="Dirección" value="<?php echo (isset($_SESSION['direccion'])) ? $_SESSION['direccion'] : '' ?>"  required>
            <span class="glyphicon glyphicon-user form-control-feedback"></span>
          </div>
