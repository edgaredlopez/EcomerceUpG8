<header class="main-header">
  <nav class="navbar navbar-static-top"> <!--class="navbar navbar-static-top"-->
    <div class="container">
      <div class="navbar-header">
        <!-- <a href="index.php" class="navbar-brand"><b>T</b>YT</a>-->
        ...
        <ul class="nav navbar-nav">
          ...
          <?php
            if(isset($_SESSION['user'])){
              ...
              echo "
                <li><a href='login.php'>INICIAR SESIÒN</a></li>
